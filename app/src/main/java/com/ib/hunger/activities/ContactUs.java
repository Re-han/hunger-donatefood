...
public class ContactUs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sub = findViewById(R.id.contactUssubmit);
        num = findViewById(R.id.contactUsnum);
        name = findViewById(R.id.contactUsname);
        msg = findViewById(R.id.contactUsmsg);
        ...
        sub.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (msg.getEditText().getText().length() == 0) {
                    msg.setError("Fields can't be Empty");
                }
                else
                {

                    getContact(num.getEditText().getText().toString(),name.getEditText().getText().toString(),msg.getEditText().getText().toString());
                   // msg.setError("");
                }
            }
        });
    ...
    private void getContact(String num, String name, String mess) {
...
//                        finish();
                        ...
                        //    PrefManager.insertData(ChangePassword.this, Contants.email,email);
