...
public class LoginAsDonorForgotPassword extends AppCompatActivity {
    TextView goback;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_login_as_receiver_forgot_password);
        Objects.requireNonNull(getSupportActionBar()).setDisplayHomeAsUpEnabled(true);
        goback = findViewById(R.id.ladgoBack);
        email = findViewById(R.id.ladfpemail);
        sub = findViewById(R.id.ladfsubmitButton);
            ...
            public void onResponse(String response) {
                ...
                try{
                    ...
                    if(res.equals("success")) {
                        ...
                        startActivity(new Intent(LoginAsDonorForgotPassword.this, LoginAsDonor.class));
                        finish();
